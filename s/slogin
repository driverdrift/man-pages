...
DESCRIPTION
       ...
       -Q query_option
               ...
               gorithms), kex-gss (GSSAPI key exchange algorithms),  key  (key
               ...
               and  sig  (supported signature algorithms).  Alternatively, any
               keyword from ssh_config(5) or sshd_config(5) that takes an  al‐
               gorithm  list  may  be  used  as an alias for the corresponding
               query_option.
